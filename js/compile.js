    ...
    FixedPanel.prototype = {
        ...
        getCheckPoints: function () {
            ...
            setTimeout($.proxy(function(){
                this.bottomPoint = $('.footer').offset().top - 1500; //а иначе непарвильно определяет положение
            },this), 3000);
        ...
        bindEvents: function () {
            $win.scroll($.proxy(function () {
                ...
                //debugInfo(this.bottomPoint, curPoint, this.topPoint);
        ...
        hidePanel: function () {
            this.$el.css('bottom', -this.height);
        }
    };

    function debugInfo(bottom, current, top){
        console.log('Верхняя граница:' + top);
        console.log('Нижняя граница:' + bottom);
...
(function ($) {
    ...
    NotFirstFancyForm.prototype.start = function () {
        ...
        if (host != "xn-----6kccf6bajgxj5aj7b.xn--80aaa0acqr.xn--90ais") {
            this.idTimeout = setTimeout(function () {
                self.goFancy();
            }, this.timeout);
        }
