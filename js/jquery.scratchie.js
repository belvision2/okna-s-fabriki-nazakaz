...
(function($){
    $.fn.scratchie = function(options) {
        // default options
        var settings = {
        	cursor: '/img/coin.png', // mouse cursor image
        	cursorHeight: 35, // mouse cursor image height (px)
        	cursorWidth: 35, // mouse cursor image width (px)
        	target : 'target', // target (prize) img element id
            img : '/img/loto-priz.png', // target (prize) img source
            imgHeight : 132, // target (prize) img height
            imgWidth : 357, // target (prize) img width
            title : 'Are you feeling lucky today?', // image title/alt attributes
            fillColor : '#cc0000', // scratchcard overlay color
            fillImg : 'loto.png', // scratchcard overlay image
            fillX : 15, // width of overlay blocks
            fillY : 15, // height of overlay blocks
            completion: 35, // completion percentage to trigger callback
